...
fn winit_to_keycode(key: WinitKey) -> Option<KeyCode> {
    Some(match key {
        ...
        WinitKey::Digit0 => KeyCode::Key0,
        WinitKey::Digit1 => KeyCode::Key1,
        WinitKey::Digit2 => KeyCode::Key2,
        WinitKey::Digit3 => KeyCode::Key3,
        WinitKey::Digit4 => KeyCode::Key4,
        WinitKey::Digit5 => KeyCode::Key5,
        WinitKey::Digit6 => KeyCode::Key6,
        WinitKey::Digit7 => KeyCode::Key7,
        WinitKey::Digit8 => KeyCode::Key8,
        WinitKey::Digit9 => KeyCode::Key9,
        ...
        WinitKey::ShiftRight => KeyCode::RightShift,
        WinitKey::ControlLeft => KeyCode::LeftCtrl,
        WinitKey::ControlRight => KeyCode::RightCtrl,
        WinitKey::AltLeft => KeyCode::LeftAlt,
        WinitKey::AltRight => KeyCode::RightAlt,
        ...
        WinitKey::Equal => KeyCode::Equal,
        WinitKey::BracketLeft => KeyCode::LeftBracket,
        WinitKey::BracketRight => KeyCode::RightBracket,
        WinitKey::Backslash => KeyCode::Backslash,
        WinitKey::Semicolon => KeyCode::Semicolon,
        WinitKey::Quote => KeyCode::Apostrophe,
        WinitKey::Backquote => KeyCode::Grave,
        WinitKey::Comma => KeyCode::Comma,
        WinitKey::Period => KeyCode::Period,
        WinitKey::Slash => KeyCode::Slash,
        WinitKey::CapsLock => KeyCode::CapsLock,
        WinitKey::NumLock => KeyCode::NumLock,
        WinitKey::ScrollLock => KeyCode::ScrollLock,
...
mod tests {
    ...
    fn key_mapping_modifiers() {
        assert_eq!(
            winit_to_keycode(WinitKey::ShiftLeft),
            Some(KeyCode::LeftShift)
        );
        assert_eq!(
            winit_to_keycode(WinitKey::ControlLeft),
