...
impl NvEncOpenEncodeSessionExParams {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_OPEN_ENCODE_SESSION_EX_PARAMS_VER);
    }
    pub fn set_device_type_directx(&mut self) {
        self.write_u32(4, NV_ENC_DEVICE_TYPE_DIRECTX);
    }
    pub fn set_device_type_cuda(&mut self) {
        self.write_u32(4, NV_ENC_DEVICE_TYPE_CUDA);
    }
    pub fn set_device(&mut self, ctx: CUcontext) {
        self.write_ptr(8, ctx);
    }
    pub fn set_api_version(&mut self) {
        self.write_u32(24, NVENCAPI_VERSION);
    }
}
...
impl NvEncInitializeParams {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_INITIALIZE_PARAMS_VER);
    }
    pub fn set_encode_guid(&mut self, guid: &GUID) {
        self.write_guid(4, guid);
    }
    pub fn set_preset_guid(&mut self, guid: &GUID) {
        self.write_guid(20, guid);
    }
    pub fn set_encode_width(&mut self, w: u32) {
        self.write_u32(36, w);
    }
    pub fn set_encode_height(&mut self, h: u32) {
        self.write_u32(40, h);
    }
    pub fn set_dar_width(&mut self, w: u32) {
        self.write_u32(44, w);
    }
    pub fn set_dar_height(&mut self, h: u32) {
        self.write_u32(48, h);
    }
    pub fn set_frame_rate_num(&mut self, n: u32) {
        self.write_u32(52, n);
    }
    pub fn set_frame_rate_den(&mut self, d: u32) {
        self.write_u32(56, d);
    }
    pub fn set_enable_encode_async(&mut self, v: u32) {
        self.write_u32(60, v);
    }
    pub fn set_enable_ptd(&mut self, v: u32) {
        self.write_u32(64, v);
    }
    pub fn set_encode_config(&mut self, cfg: *mut c_void) {
        self.write_ptr(88, cfg);
    }
    pub fn set_tuning_info(&mut self, v: u32) {
        self.write_u32(136, v);
    }
}
...
impl NvEncConfig {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_CONFIG_VER);
    }
    // profileGUID at offset 4 (16 bytes)
    pub fn set_profile_guid(&mut self, guid: &GUID) {
        self.write_guid(4, guid);
    }
    pub fn set_gop_length(&mut self, v: u32) {
        self.write_u32(20, v);
    }
    // rcParams starts at offset 40
    pub fn set_rc_mode(&mut self, v: u32) {
        self.write_u32(40 + 4, v);
    }
    pub fn set_avg_bitrate(&mut self, v: u32) {
        self.write_u32(40 + 20, v);
    }
    pub fn set_max_bitrate(&mut self, v: u32) {
        self.write_u32(40 + 24, v);
    }
...
impl NvEncPresetConfig {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_PRESET_CONFIG_VER);
    }
    /// Set the inner presetCfg.version (at offset 8)
    pub fn set_config_version(&mut self) {
        self.write_u32(8, NV_ENC_CONFIG_VER);
    }
...
impl NvEncPicParams {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_PIC_PARAMS_VER);
    }
    pub fn set_input_width(&mut self, v: u32) {
        self.write_u32(4, v);
    }
    pub fn set_input_height(&mut self, v: u32) {
        self.write_u32(8, v);
    }
    pub fn set_input_pitch(&mut self, v: u32) {
        self.write_u32(12, v);
    }
    pub fn set_encode_pic_flags(&mut self, v: u32) {
        self.write_u32(16, v);
    }
    pub fn set_input_timestamp(&mut self, v: u64) {
        self.write_u64(24, v);
    }
    pub fn set_input_buffer(&mut self, v: *mut c_void) {
        self.write_ptr(40, v);
    }
    pub fn set_output_bitstream(&mut self, v: *mut c_void) {
        self.write_ptr(48, v);
    }
    pub fn set_buffer_fmt(&mut self, v: u32) {
        self.write_u32(64, v);
    }
    pub fn set_picture_struct(&mut self, v: u32) {
        self.write_u32(68, v);
    }
}
...
impl NvEncRegisterResource {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_REGISTER_RESOURCE_VER);
    }
    pub fn set_resource_type(&mut self, v: u32) {
        self.write_u32(4, v);
    }
    ...
    pub fn set_resource_to_register(&mut self, v: *mut c_void) {
        self.write_ptr(24, v);
    }
    pub fn registered_resource(&self) -> *mut c_void {
        self.read_ptr(32)
    }
    pub fn set_buffer_format(&mut self, v: u32) {
        self.write_u32(40, v);
    }
    pub fn set_buffer_usage(&mut self, v: u32) {
        self.write_u32(44, v);
    }
}
...
impl NvEncMapInputResource {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_MAP_INPUT_RESOURCE_VER);
    }
    pub fn set_registered_resource(&mut self, v: *mut c_void) {
        self.write_ptr(16, v);
    }
    pub fn mapped_resource(&self) -> *mut c_void {
        self.read_ptr(24)
    }
    pub fn mapped_buffer_fmt(&self) -> u32 {
        self.read_u32(32)
    }
}
...
impl NvEncLockBitstream {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_LOCK_BITSTREAM_VER);
    }
    pub fn set_output_bitstream(&mut self, v: *mut c_void) {
        self.write_ptr(8, v);
    }
    pub fn bitstream_size(&self) -> u32 {
        self.read_u32(36)
    }
    pub fn bitstream_ptr(&self) -> *const u8 {
        self.read_ptr(56) as *const u8
    }
...
impl NvEncCreateBitstreamBuffer {
    pub fn set_version(&mut self) {
        self.write_u32(0, NV_ENC_CREATE_BITSTREAM_BUFFER_VER);
    }
    pub fn bitstream_buffer(&self) -> *mut c_void {
        self.read_ptr(16)
    }
}
...
pub type FnOpenEncodeSessionEx =
    unsafe extern "C" fn(params: *mut c_void, encoder: *mut *mut c_void) -> NVENCSTATUS;

pub type FnInitializeEncoder =
    unsafe extern "C" fn(encoder: *mut c_void, params: *mut c_void) -> NVENCSTATUS;

pub type FnEncodePicture =
    unsafe extern "C" fn(encoder: *mut c_void, params: *mut c_void) -> NVENCSTATUS;
...
impl NvFbcGetStatusParams {
    ...
    pub fn nvfbc_version(&self) -> u32 {
        self.read_u32(772)
    }
    pub fn can_create_now(&self) -> bool {
        self.read_u32(12) != 0
    }
}
...
impl NvFbcCreateCaptureSessionParams {
    ...
    pub fn set_tracking_type(&mut self, v: u32) {
        self.write_u32(8, v);
    }
    pub fn set_with_cursor(&mut self, v: u32) {
        self.write_u32(40, v);
    }
    pub fn set_sampling_rate_ms(&mut self, v: u32) {
        self.write_u32(52, v);
    }
    pub fn set_push_model(&mut self, v: u32) {
        self.write_u32(56, v);
    }
}
...
impl NvFbcToCudaGrabFrameParams {
    ...
    pub fn set_cuda_device_buffer(&mut self, v: *mut c_void) {
        self.write_ptr(8, v);
    }
...
pub type FnNvFbcGetLastErrorStr =
    unsafe extern "C" fn(handle: NVFBC_SESSION_HANDLE) -> *const std::ffi::c_char;
pub type FnNvFbcApi =
    unsafe extern "C" fn(handle: NVFBC_SESSION_HANDLE, params: *mut c_void) -> NVFBCSTATUS;
pub type FnNvFbcCreateHandle =
    unsafe extern "C" fn(handle: *mut NVFBC_SESSION_HANDLE, params: *mut c_void) -> NVFBCSTATUS;
